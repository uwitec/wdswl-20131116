...
public class ButtonAssets extends HashMap {
	...
	public static final ButtonObject m_boQuery = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("common",
					"UC001-0000006")/* @res "查询" */, nc.ui.ml.NCLangRes
					.getInstance().getStrByID("uifactory_report",
							"UPPuifactory_report-000000")/* @res "查询单据" */, 0,
			"查询");
	...
	public static final ButtonObject m_boPrintPreview = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000001")/* @res "打印预览" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000001")/* @res "打印预览" */, 0, "打印预览");

	public static final ButtonObject m_boPrintDirect = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000002")/* @res "直接打印" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000003")/* @res "打印单据" */, 0, "直接打印");

	public static final ButtonObject m_boPrintTemplet = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000004")/* @res "模板打印" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000003")/* @res "打印单据" */, 0, "模板打印");

	public static final ButtonObject m_boPrint = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("common",
					"UC001-0000007")/* @res "打印" */, new ButtonObject[] {
					m_boPrintPreview, m_boPrintDirect, m_boPrintTemplet });
	static {
		m_boPrint.setCode("打印");
	}

	public static final ButtonObject m_boSort = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000005")/* @res "排序" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000006")/* @res "排序设置" */, 0, "排序");
	public static final ButtonObject m_boLevelSubTotal = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000007")/* @res "分级小计" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000007")/* @res "分级小计" */, 0, "分级小计"); /*
																				 * -=notranslate
																				 * =
																				 * -
																				 */
	// public ButtonObject m_boTest = new ButtonObject("测试", "测试", 0);
	public static final ButtonObject m_boCodeLevelSubTotal = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000008")/* @res "编码级次小计" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000008")/* @res "编码级次小计" */, 0,
			"编码级次小计"); /* -=notranslate=- */

	public static final ButtonObject m_boSubTotal = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000009")/* @res "小计合计" */,
			new ButtonObject[] { m_boLevelSubTotal, m_boCodeLevelSubTotal });

	public static final ButtonObject m_boColumnFilter = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000010")/* @res "栏目设置" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000010")/* @res "栏目设置" */, 0, "栏目设置");

	public static final ButtonObject m_boCross = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000011")/* @res "交叉设置" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000011")/* @res "交叉设置" */, 0, "交叉设置");

	public static final ButtonObject m_boFilter = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000012")/* @res "过滤" */,
			nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report",
					"UPPuifactory_report-000012")/* @res "过滤" */, 0, "过滤");
	public static final ButtonObject refresh = new ButtonObject("刷新", "刷新数据",
			IReportButton.onboRefresh);

	public static final ButtonObject m_boRefresh = new ButtonObject(
			nc.ui.ml.NCLangRes.getInstance().getStrByID("common",
	...
	// public static final ButtonObject m_boGroup = new
	// ButtonObject(nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report","UPPuifactory_report-000013")/*@res
	// "分组"*/,
	// nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report","UPPuifactory_report-000014")/*@res
	// "分组显示"*/,
	// 0,"分组显示");

	public static final ButtonObject m_boPenerate = new ButtonObject("穿透",
			"双击业务行/列亦可穿透", 0, "穿透");
	...
	/**
	 * @return 返回子按钮除外的所有按钮 穿透按钮 需要根据reportBaseUI.getPene2NodeInfo() == null 判断
	 */
	public ArrayList getVisibleButtonsByOrder() {
		ArrayList<ButtonObject> al = new ArrayList<ButtonObject>();
		// saf/070822/
		if (reportBaseUI.getReportButtonAry() != null
				&& reportBaseUI.getReportButtonAry().length > 0) {
